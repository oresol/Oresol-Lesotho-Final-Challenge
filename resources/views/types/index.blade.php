        ...
        <ul class="list-group my-4">
            @foreach ($types as $type)
                <li class="list-group-item">
                    <form id="{{$type->typename.'fm'}}" class="w-100 my-2" style="display: none" action="{{route('typeupdate', $type->id)}}" method="POST">
                        @csrf
                        <div class="form-group d-flex justify-content-between">
                            <div style="width: 80%">
                    ...
                    <div id="{{$type->typename}}" class="d-flex justify-content-between">
                        ...
                        <span> 
                            <a onclick="editItem({{$type->typename}})" style="width: 4.5rem;" class="btn btn-info">Edit</a>
