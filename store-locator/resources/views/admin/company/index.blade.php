    ...
    <div class="card">
        <div class="card-header bg-success text-white">
            <div class="d-flex justify-content-between align-items-center">
                ...
                @endforeach
                    <a href="#" data-toggle="modal" data-target="#profile" class="btn btn-light">Add Company Details</a>
                </div>
            </div>
        ...
        <div class="row">
            ...
            @foreach ($company as $profile)
                ...
                <li class="list-group-item"><strong>Telephone Number:</strong> {{ $profile->telephone_number }}</li>
                <li class="list-group-item"><strong>Member Since:</strong> {{ $profile->created_at->format('F j, Y') }}</li>
           @endforeach
            </ul>
            </div>
        </div>
            ...
            <div class="card">
                ...
                <form method="POST" action="/company">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="telephone_number" name="telephone_number" placeholder="Enter Telephone Number" required>
                    </div>
        ...
        <div class="modal-body">
            ...
            <div class="card">
                ...
                <form method="POST" action="/company/{{ $profile->id }}">
                    ...
                    <div class="form-group">
                        <label for="company_name">Company Name</label>
                        <input type="text" class="form-control" id="company_name" name="company_name" value="{{$profile->company_name}}" placeholder="Enter Company Name" required>
                    </div>
                    @error('company_name')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror<br>
                    <div class="form-group">
                        <label for="website">Website</label>
                        <input type="text" class="form-control" id="website" name="website" value="{{$profile->website}}" placeholder="Enter Website" required>
                    </div>
                    @error('website')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror<br>
                    ...
                    <div class="form-group">
                        <label for="telephone_number">Telephone</label>
                        <input type="text" class="form-control" id="telephone_number" name="telephone_number" value="{{$profile->telephone_number}}" placeholder="Enter Telephone Number" required>
                    </div>
                    @error('telephone_number')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror<br>
