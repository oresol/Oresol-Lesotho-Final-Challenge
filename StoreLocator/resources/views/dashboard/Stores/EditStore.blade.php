    ...
    <div class="container">
        <div class="card border border-light">
            ...
            <div class="card-body">
                ...
                @endif
                <form method="POST" action="/stores/{{ $store->id }}" accept="image/*" enctype="multipart/form-data">
                    @method('PUT')
                    @csrf
                    <div class="row mb-4">
                        <div class="col">
                            <div class="form-outline">
                                ...
                                <input type="text" name="storeName"
                                    ...
                                    value="{{ $store->storeName }}" id="form6Example11" />
                                @error('storeName')
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col">
                            <div class="form-outline">
                                ...
                                <input type="text" id="formExample1" name="longitude" value="{{ $store->longitude }}"
                    ...
                    <div class="row mb-4">
                        <div class="col">
                            <div class="form-outline">
                                ...
                                <input type="text" id="form6Example" name="latitude" value=" {{ $store->latitude }}"
